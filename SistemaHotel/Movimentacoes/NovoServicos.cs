...
namespace SistemaHotel.Movimentacoes
{
    public partial class FrmNovoServics : Form
    {
        ...
        private void FormatarDG()
        {
            ...
            grid.Columns[3].HeaderText = "CNPJ";
            
            grid.Columns[4].HeaderText = "Serviço";
            grid.Columns[5].HeaderText = "Quarto";
            grid.Columns[6].HeaderText = "Valor";
        ...
        private void BtnSalvar_Click(object sender, EventArgs e)
        {
            ...
            con.AbrirCon();
            sql = "INSERT INTO novo_servico (hospede, nome_empresa, cnpj, servico, quarto, valor, funcionario, data) VALUES (@hospede, @nome_empresa, @cnpj, @servico, @quarto, @valor, @funcionario, curDate())";
            cmd = new MySqlCommand(sql, con.con);
            cmd.Parameters.AddWithValue("@hospede", txtNome.Text);
            cmd.Parameters.AddWithValue("@nome_empresa", txtNomeEmpresa.Text);
            ...
            cmd.Parameters.AddWithValue("@movimento", "Lançamento NF-e");
            ...
            MessageBox.Show("Nota Fiscal inserida com suceso!", "Dados Salvo", MessageBoxButtons.OK, MessageBoxIcon.Information);
